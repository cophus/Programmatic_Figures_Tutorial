function [] = animAtoms01a(atomData,atomLattice,cameraPosition)

% Colin Ophus - clophus@lb2 l.gov - 2020 February
% APS tutorial example 0- plotting atoms from the FePt sample
...
splitPlanesShift = -1;  % additive shift of atomic planes
splitPlanesDistance = 70;  % multiplicative shift of atomic planes (spacing)
